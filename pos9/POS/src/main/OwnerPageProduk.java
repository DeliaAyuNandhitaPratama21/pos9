 ...
 * @author ASUS
 */
public class OwnerPageProduk extends javax.swing.JFrame {

    DataProduk p; // Untuk menyimpan informasi produk
    
    /**
     * Creates new form AdminPage1
     */
    DefaultTableModel model2; // Model tabel untuk menampilkan data produk
    public OwnerPageProduk() {
        initComponents();
    }
    
    public OwnerPageProduk(DataProduk P) {
        initComponents();
        
        viewProduk(""); // Memanggil metode untuk menampilkan data produk
    ...
    // Button yang mengarah ke halaman tambah produk
    ...
    // Kolom pencarian untuk mencari data produk
    ...
    // Untuk refresh tabel agar muncul produk yang telah ditambahkan atau diubah
...
//            JOptionPane.showMessageDialog(this, id); 
    ...
    // icon keluar untuk keluar halaman produk 
    ...
    // Label untuk menuju halaman user
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OwnerPageProduk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OwnerPageProduk().setVisible(true);
            }
        });
    }
...
// Metode viewProduk untuk menampilkan data produk dari database berdasarkan filter
    public static void viewProduk(String where) {
        ...
        try {
            ...
            // Melakukan koneksi ke database dan eksekusi query untuk mendapatkan data produk
            Connection K = Koneksi.conn();
            Statement S = K.createStatement();
            ...
            while (R.next()) {                 
                ...
                // Menambahkan baris data produk ke model tabel
